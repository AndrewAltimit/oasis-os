...
10. [Briefcase Agent Terminal](#10-briefcase-agent-terminal-planned)
11. [PSP Remote Agent Control](#11-psp-remote-agent-control-planned)
...
|   +-- oasis-skin/                  # TOML skin engine, 20 skins, theme derivation from 9 base colors
