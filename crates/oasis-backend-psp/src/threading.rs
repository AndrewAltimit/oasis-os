...
fn decode_aac_frame(
    ...
    static DECODE_COUNT: core::sync::atomic::AtomicU32 = core::sync::atomic::AtomicU32::new(0);
    ...
    match decoder.decode(data, &mut pcm) {
        ...
        Err(e) => {
            static ERR_COUNT: core::sync::atomic::AtomicU32 = core::sync::atomic::AtomicU32::new(0);
